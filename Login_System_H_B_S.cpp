...
public:
    ...
    // Pure virtual function for bill calculation (implemented by child classes)
...
public:
    ...
    double calculateBill(int days) override { return (pricePerDay * days) * 0.95; } // 5% discount
};
...
public:
    ...
    double calculateBill(int days) override { return (pricePerDay * days) * 0.9; } // 10% discount
};
